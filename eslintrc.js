...
module.exports = {
	env: {
		...
		es6: true, // we cannot use all of es6 features but some of them are already supported accross browsers (like Map)
		jasmine: true, // we are using Jasmine for unit tests
	},
	parserOptions: {
		sourceType: 'module',
		ecmaFeatures: {
	...
	rules: {
		...
		complexity: ['error', { max: 20 }],	            //	enforce a maximum cyclomatic complexity allowed in a program
		...
		'no-trailing-spaces': ['error', { skipBlankLines: false }],	//	autofixable disallow trailing whitespace at the end of lines
		...
		'prefer-arrow-callback': ['error', { allowNamedFunctions: true }],			        //	autofixable require arrow functions as callbacks
